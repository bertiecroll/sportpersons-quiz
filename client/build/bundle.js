...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quiz = __webpack_require__(197);
	...
	var url = "https://gist.githubusercontent.com/joshheald/d26b89b0fbaf4e26cb423913ada21b83/raw/174a7ac0916919d4ae171adcfc0af78811b185f3/sportspeople.json";
	
	var store = (0, _redux.createStore)(_quiz2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quiz = __webpack_require__(198);
	
	var QuizActionTypes = _interopRequireWildcard(_quiz);
...
/***/ function(module, exports) {
	...
	var SET_QUIZ_DATA = exports.SET_QUIZ_DATA = "quiz/SET_QUIZ_DATA";
	var SET_USER_PREFS = exports.SET_USER_PREFS = "quiz/SET_USER_PREFS";
	var UPDATE_SCORE_CARD = exports.UPDATE_SCORE_CARD = "quiz/UPDATE_SCORE_CARD";
	var RESET_QUIZ = exports.RESET_QUIZ = "quiz/RESET_QUIZ";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quiz = __webpack_require__(200);
	
	var QuizActions = _interopRequireWildcard(_quiz);
	
	var _CollectionHelper = __webpack_require__(201);
	
	var _CollectionHelper2 = _interopRequireDefault(_CollectionHelper);
	
	var _ResultTracker = __webpack_require__(202);
	
	var _ResultTracker2 = _interopRequireDefault(_ResultTracker);
	
	var _Quiz = __webpack_require__(203);
	
	var _Quiz2 = _interopRequireDefault(_Quiz);
	
	var _Start = __webpack_require__(209);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.apiResponseAction = _this.apiResponseAction.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          user = _props.user,
	          totalRounds = _props.totalRounds,
	          cardsOnShow = _props.cardsOnShow,
	          result = _props.result,
	          dispatch = _props.dispatch;
	
	      var setUserPrefs = (0, _redux.bindActionCreators)(QuizActions.setUserPrefs, dispatch);
	      var updateScoreCard = (0, _redux.bindActionCreators)(QuizActions.updateScoreCard, dispatch);
	      var resetQuiz = (0, _redux.bindActionCreators)(QuizActions.resetQuiz, dispatch);
	
	      return user ? _react2.default.createElement(_Quiz2.default, {
	        ...
	        user: user,
	        result: result
	      }) : _react2.default.createElement(_Start2.default, { setUserPrefs: setUserPrefs });
	    }
	  }, {
	    key: 'apiResponseAction',
	    value: function apiResponseAction(event) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	  var amountOfCards = state.scoreCard.length + 2;
	  return {
	    user: state.user,
	    cardsOnShow: _CollectionHelper2.default.sample(state.quiz_data, amountOfCards),
	    totalRounds: state.totalRounds,
	    result: _ResultTracker2.default.check(state.scoreCard, state.totalRounds)
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.resetQuiz = exports.updateScoreCard = exports.setUserPrefs = exports.setQuizData = undefined;
	...
	var setQuizData = exports.setQuizData = function setQuizData(dataSet) {
	  return {
	...
	var setUserPrefs = exports.setUserPrefs = function setUserPrefs(user, totalRounds) {
	  return {
	...
	var updateScoreCard = exports.updateScoreCard = function updateScoreCard(score) {
	  return {
	...
	var resetQuiz = exports.resetQuiz = function resetQuiz() {
	  return {
...
/***/ function(module, exports) {
	...
	var CollectionHelper = function () {
	  ...
	  _createClass(CollectionHelper, null, [{
	    key: "sample",
	    value: function sample(array, amount) {
	      var shuffledArray = this._shuffleArray(array);
	      return shuffledArray.slice(0, amount);
	    }
	  }, {
	    key: "findTopItemIndex",
	    value: function findTopItemIndex(key, array) {
	      return array.reduce(function (winningIndex, currentItem, currentIndex) {
	        return array[winningIndex][key] > currentItem[key] ? winningIndex : currentIndex;
	      }, 0);
	    }
	  }, {
	    key: "_shuffleArray",
...
/***/ function(module, exports) {
	...
	var ResultTracker = function () {
	  function ResultTracker() {
	    _classCallCheck(this, ResultTracker);
	  }
	
	  _createClass(ResultTracker, null, [{
	    key: "check",
	    value: function check(scoreCard, totalRounds) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _End = __webpack_require__(207);
	...
	var Quiz = function (_React$Component) {
	  ...
	  function Quiz(props) {
	    ...
	    return _possibleConstructorReturn(this, (Quiz.__proto__ || Object.getPrototypeOf(Quiz)).call(this));
	  }
	  ...
	  _createClass(Quiz, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          user = _props.user,
	          updateScoreCard = _props.updateScoreCard,
	          resetQuiz = _props.resetQuiz,
	          totalRounds = _props.totalRounds,
	          cardsOnShow = _props.cardsOnShow,
	          result = _props.result;
	
	
	      var content = result === null ? _react2.default.createElement(_Display2.default, {
	        updateScoreCard: updateScoreCard,
	        totalRounds: totalRounds,
	        cardsOnShow: cardsOnShow,
	        user: user
	      }) : _react2.default.createElement(_End2.default, { result: result, user: user, resetQuiz: resetQuiz });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageBox = __webpack_require__(206);
	  ...
	  _createClass(Display, [{
	    ...
	    value: function render() {
	      ...
	      var _state = this.state,
	          topIndex = _state.topIndex,
	          chosenIndex = _state.chosenIndex;
	      var _props = this.props,
	          cardsOnShow = _props.cardsOnShow,
	          user = _props.user,
	          totalRounds = _props.totalRounds;
	      ...
	      var round = cardsOnShow.length - 1;
	      var cards = cardsOnShow.map(function (card, index) {
	        return _react2.default.createElement(_Card2.default, {
	          styleName: chosenIndex !== null ? "card-no-click" : "card-click",
	          handleClick: chosenIndex !== null ? null : _this2.handleCardClick,
	          key: index,
	          index: index,
	          topIndex: topIndex,
	          card: card
	    ...
	    value: function handleCardClick(event) {
	      ...
	      var topIndex = _CollectionHelper2.default.findTopItemIndex('points', this.props.cardsOnShow);
	      var chosenIndex = parseInt(event.target.getAttribute('value'));
	      this.setState({ chosenIndex: chosenIndex });
	
	      setTimeout(function () {
	        _this3.setState({ topIndex: topIndex });
	      }, 1000);
	
	      var result = topIndex === chosenIndex;
	      setTimeout(function () {
	        _this3.setState({ topIndex: null, chosenIndex: null });
	        _this3.props.updateScoreCard(result);
	      }, 3000);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = function Card(_ref) {
	  var styleName = _ref.styleName,
	      card = _ref.card,
	      index = _ref.index,
	      topIndex = _ref.topIndex,
	      handleClick = _ref.handleClick;
	
	
	  var mvpImage = index === topIndex ? _react2.default.createElement("img", { className: "mvp-logo", src: "/images/MVPlogo.png" }) : null;
	
	  var points = topIndex !== null ? _react2.default.createElement(
	    "h4",
	    null,
	    "Points: ",
	    card.points.toFixed(2)
	  ) : null;
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement("img", { src: card.profile_picture_url, onClick: handleClick, value: index }),
	    points
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBox = function MessageBox(_ref) {
	  var user = _ref.user,
	      chosenCard = _ref.chosenCard,
	      totalRounds = _ref.totalRounds,
	      round = _ref.round;
	
	
	  var content = chosenCard ? _react2.default.createElement(
	    "h3",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quotes = __webpack_require__(208);
	...
	var End = function (_React$Component) {
	  ...
	  _createClass(End, [{
	    ...
	    value: function render() {
	      ...
	      var sampleQuote = _CollectionHelper2.default.sample(_quotes.quotes, 1)[0];
	
	      var content = result ? _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'h1',
	        ...
	        _react2.default.createElement('div', { className: 'champion-image' })
	      ) : _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoundsToggle = __webpack_require__(210);
	
	var _RoundsToggle2 = _interopRequireDefault(_RoundsToggle);
	
	var _ErrorBox = __webpack_require__(211);
	
	var _ErrorBox2 = _interopRequireDefault(_ErrorBox);
	
	var _RulesBox = __webpack_require__(212);
	
	var _RulesBox2 = _interopRequireDefault(_RulesBox);
	...
	var Start = function (_React$Component) {
	  ...
	  function Start(props) {
	    ...
	    _this.updateTotalRounds = _this.updateTotalRounds.bind(_this);
	  ...
	  _createClass(Start, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'start-component' },
	        _react2.default.createElement(
	          'h1',
	          null,
	          'Sportpersons Quiz'
	        ),
	        _react2.default.createElement(_ErrorBox2.default, {
	        ...
	        _react2.default.createElement('input', { type: 'text', placeholder: 'Enter Name', onChange: this.updateUserName }),
	        _react2.default.createElement(_RoundsToggle2.default, {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_RulesBox2.default, null)
	        )
	      );
	    }
	  }, {
	    ...
	    key: 'updateTotalRounds',
	    value: function updateTotalRounds(value) {
	      var newTotal = this.state.totalRounds + value;
	      if (newTotal > 0 && newTotal < 6) this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoundsToggle = function (_React$Component) {
	  _inherits(RoundsToggle, _React$Component);
	
	  function RoundsToggle(props) {
	    _classCallCheck(this, RoundsToggle);
	
	    var _this = _possibleConstructorReturn(this, (RoundsToggle.__proto__ || Object.getPrototypeOf(RoundsToggle)).call(this));
	
	    _this.handleIncreaseClick = _this.handleIncreaseClick.bind(_this);
	    _this.handleDecreaseClick = _this.handleDecreaseClick.bind(_this);
	    return _this;
	  }
	
	  _createClass(RoundsToggle, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        ...
	        _react2.default.createElement(
	          "button",
	          { onClick: this.handleDecreaseClick, className: "decrease-button" },
	          "-"
	        ),
	        _react2.default.createElement(
	          "button",
	          { onClick: this.handleIncreaseClick, className: "increase-button" },
	          "+"
	        )
	      );
	    }
	    ...
	    value: function handleIncreaseClick() {
	      this.props.updateTotalRounds(1);
	    }
	  }, {
	    key: "handleDecreaseClick",
	    value: function handleDecreaseClick() {
	      this.props.updateTotalRounds(-1);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RulesBox = function (_React$Component) {
	  _inherits(RulesBox, _React$Component);
	
	  function RulesBox(props) {
	    _classCallCheck(this, RulesBox);
	
	    var _this = _possibleConstructorReturn(this, (RulesBox.__proto__ || Object.getPrototypeOf(RulesBox)).call(this));
	  ...
	  _createClass(RulesBox, [{
	    key: 'render',
	    value: function render() {
	      var content = this.state.displayRules ? _react2.default.createElement(
	        'p',
...
/***/ function(module, exports) {
	...
	var rules = exports.rules = "KnockOut Quiz Guessing Game. Select number of rounds, each round number of players increases. Select player who you believe has highest points. Make it to the end to win, get one wrong and your out!";
